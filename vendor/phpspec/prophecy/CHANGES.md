...
==================
  ...
  * Fix the edge case when failed Matches weren't recorded for `getCheckedMatches()`

1.3.0 / 2014-11-14
==================

  * Add a way to get checked Matches with `MethodProphecy::getCheckedMatches()`
...
==================
  ...
  * Fixed the support of array callables in CallbackPromise and CallbackMatch(thanks @ciaranmcnulty)
...
========================
  ...
  * Add more debug information to CallTimes and Call Matchexception messages
