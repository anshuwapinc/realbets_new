...
class ProphetSpec extends ObjectBehavior
{
    ...
    function it_does_nothing_during_checkMatches_call_if_no_Matches_defined()
    {
        $this->checkMatches()->shouldReturn(null);
    }

    function it_throws_AggregateException_if_defined_Matches_fail(
