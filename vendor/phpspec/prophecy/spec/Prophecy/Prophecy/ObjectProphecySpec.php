...
class ObjectProphecySpec extends ObjectBehavior
{
    ...
    function it_returns_null_after_checkMatches_call_if_there_is_no_method_prophecies()
    {
        $this->checkProphecyMethodsMatches()->shouldReturn(null);
    }

    function it_throws_AggregateException_during_checkMatches_if_Matches_fail(
        ...
        $this->shouldThrow('Prophecy\Exception\Prediction\AggregateException')
            ->duringCheckProphecyMethodsMatches();
    }
