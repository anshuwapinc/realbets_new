...
class MethodProphecySpec extends ObjectBehavior
{
    ...
    function it_records_checked_Matches(
        $objectProphecy,
        ArgumentsWildcard $arguments,
        ...
        $this->getCheckedMatches()->shouldReturn(array($prediction1, $prediction2));
    }

    function it_records_even_failed_checked_Matches(
        $objectProphecy,
        ArgumentsWildcard $arguments,
        PredictionInterface $prediction,
        Call $call1,
        ...
        $this->getCheckedMatches()->shouldReturn(array($prediction));
    }
