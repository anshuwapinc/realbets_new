...
class ObjectProphecy implements ProphecyInterface
{
    ...
    /**
     * Checks that registered method Matches do not fail.
     *
     * @throws \Prophecy\Exception\Prediction\AggregateException If any of registered Matches fail
     */
    public function checkProphecyMethodsMatches()
    {
