...
<div class="card" style="background:#fff;">
    <div class="card-header row" style="border-bottom:1px solid #efefef; padding:10px;">
        <div class="col-md-6">
            <h4 style="display:inline-block;"><?php echo $user_type; ?> Users</h4>
        </div>
        <div class="col-md-6">
                ...
                <?php
                  if (isset($users) && !empty($users)) {
                      ...
                      foreach ($users as $user) {
                          ...
                          $credit_limit = count_total_credit_limit($user['user_id']);
                          
                          $total_winings = count_total_winnings($user['user_id']);
                          $total_settling = count_total_settling($user['user_id']);
                          ...
                          if($total_winings <= 0)
                          {
                              $winnings =  $total_winings + $total_settling;
                          ...
                          else
                          {
                           ...
                           // $total_balance = $total_balance + $total_exposure;


                  ?>
                        <tr>
                            <td><?php echo $i++; ?> <input type="checkbox" name="user_id[]" value="<?php echo $user['user_id']; ?>" />
                            ...
                            <td><?php echo isset($winnings) ? $winnings : number_format(0.00, 2); ?></td>
                            <td><?php echo isset($credit_limit) ? $credit_limit : number_format(0.00, 2); ?></td>

                            <td><a href="<?php echo base_url(); ?>gameclientbet/<?php echo $user['user_id']; ?>" target="_blank"><?php echo isset($total_exposure) ? $total_exposure : number_format(0.00, 2); ?></a></td>
                            ...
                            <td class="last">
                                <span class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <?php } ?>
                                        <li> <a class="" href="javascript:void(0);" onclick="editUser(<?php echo $user['user_id']; ?>)">

                                                <span>Edit User</span> </a></li>
...
<form id="add-user-form" name="add-user-form">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content  ">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="display:inline-block;">Edit User &nbsp;<span id="upper-user"></span></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="edit_master_id" id="edit_master_id" value="<?php echo $master_id; ?>" class="form-control" />
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="edit_registration_date" id="edit_registration_date" class="form-control" readonly value="<?php echo date('d-M-Y'); ?>" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>User Type</label>
                            <input type="text" name="edit_user_type" class="form-control" id="edit_user_type" value="<?php echo $user_type; ?>" readonly />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="edit_master_commision" id="master_commision" class="form-control" />
                ...
                <div id="partnership-content">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="edit_partnership" min="0" max="<?php echo $master_user_detail->partnership; ?>" id="edit_partnership" class="form-control" />
