                            ...
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" class="table table-striped table-bordered" style="padding-bottom:100px;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_match_amt, 2); ?></strong></td>
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_sess_amt, 2); ?></strong></td>
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_total_amt, 2); ?></strong></td>
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_match_comm, 2); ?></strong></td>
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_sess_comm, 2); ?></strong></td>
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_total_comm, 2); ?></strong></td>
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_net_amt, 2); ?></strong></td>
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_share_amt, 2); ?> </strong></td>
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_mob_app, 2); ?></strong></td>
                                        <td valign="middle" style="text-align:right;"><strong><?php echo number_format($grand_total_agent_final_amt, 2); ?></strong></td>
