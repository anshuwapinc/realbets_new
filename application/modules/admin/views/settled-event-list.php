                    ...
                    <thead>
                        ...
                        if (!empty($list_events)) {
                            ...
                            foreach ($list_events as $list_event) { 
                                ...
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td><a href="<?php echo base_url(); ?>admin/settled/events/settledEventEntry/<?php echo $list_event->list_event_id; ?>"><?php echo $list_event->event_name; ?></a></td>
