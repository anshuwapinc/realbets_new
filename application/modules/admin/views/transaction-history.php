...
<div class=" listing-grid">
    <div class="detail-row">
        ...
        <div style="padding:20px">
            <ul class="nav d-flex">
                <li class="nav-item">
                    <a class="nav-link <?php echo empty($All) ? "" : $All ?>" href="<?php echo base_url('transaction-history/All') ?>">All</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo empty($Request) ? "" : $Request ?>" href="<?php echo base_url('transaction-history/Request') ?>">Pending</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo empty($Confirm) ? "" : $Confirm ?>" href="<?php echo base_url('transaction-history/Confirm') ?>">Confirmed</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo empty($Reject) ? "" : $Reject ?>" href="<?php echo base_url('transaction-history/Reject') ?>">Rejected</a>
                </li>
            </ul>
            <hr />
            <form>
...
<script>
    ...
    function filterdata() {
        ...
        // showLoading();
        $.ajax({
            url: '<?php echo base_url(); ?>transaction-history',
            data: {
