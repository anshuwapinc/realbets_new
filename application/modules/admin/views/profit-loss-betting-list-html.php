<div class="custom-scroll appendAjaxTbl" style="padding:0px;overflow:auto;">
            ...
            ?>
                        ...
                        <tr id="user_row_1262587" class="mark-back  content_user_table">
                            ...
                            <td class="mark-back">
                                ...
                                if ($betting['betting_status'] == 'Settled') {
                                    ...
                                    if ($betting['betting_type'] == 'Fancy') {
                                        echo  '(Res: ' . $betting['result_name'] . ')';
                                    } else {
                                        echo  '(Win: ' . $betting['result_name'] . ')';
                                    }
                                }
                                ?>
                            </td>
                            ...
                            <td class="mark-back"><?php echo abs($pl); ?></td>
                            <td class="mark-back"><?php echo abs($loss); ?></td>
                    ...
                    ?>
                        <tr id="mark-lay content_user_table " class="mark-lay  content_user_table">
                            ...
                            <td class="mark-lay"><?php echo abs($betting['stake']); ?></td>
                            <td class="mark-lay"><?php echo abs($betting['profit']); ?></td>

                            <td class="mark-lay"><?php echo abs($pl); ?></td>
                            <td class="mark-lay"><?php echo abs($loss); ?></td>
