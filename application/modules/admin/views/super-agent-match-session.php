                        ...
                        <td colspan="2" height="25">
                            ...
                            <table style="margin-bottom:30px;" class="table table-striped table-bordered">
                                <tbody>
                                    ...
                                    $grand_total_super_agent_match_comm = 0;
                                    $grand_total_super_agent_sess_comm = 0;
                                    $grand_total_super_agent_total_comm = 0;
                                    $grand_total_super_agent_net_amt = 0;
                                    $grand_total_super_agent_share_amt = 0;
                                    $grand_total_super_agent_final_amt = 0;
