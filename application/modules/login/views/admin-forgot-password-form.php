                    ...
                    <div id="login" class="form">
                        ...
                        <div class="login_wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" maxlength="10" minlength="10" id="login_username" name="login_username" class="form-control user_input" placeholder="Enter Your Existing Number" required="1">
                            ...
                            <div class="form-group">
                                <input type="password" type="password" name="password" id="password" class="form-control pass_input" placeholder="Enter New Password" required="1" autocomplete="off">
                            </div>
    ...
    <script type="text/javascript">
            ...
            $("#login-form").validate({
                ...
                rules: {
                    ...
                    login_username: {
                        required: true,
                        remote: {
                            url: base_url + "login/Admin/register_username_exists_for_forgot_password",
                            type: "post",
                            data: {
                                login: function() {
                ...
                messages: {
                    login_username: {
                        ...
                        remote: "Account Not Exist To Above Number.",
                    },
                    password: {
        ...
        function getOtp() {
            ...
            if ($("#login_username").val() != "") {
                $.ajax({
                    url: "<?php echo base_url(); ?>login/Admin/register_username_exists_for_forgot_password",
                    data: {
                    ...
                    success: function(output) {
                        if (output == true) {
                            ...
                            alert("Account Not Exist To This Number");
                        }
                    }
