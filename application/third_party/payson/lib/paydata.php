...
class PayData {
    ...
    public function __construct($returnUrl, $cancelUrl, $ipnUrl, $memo, $sender, $receivers, $customReceipt, $showReceiptPage) {
        ...
        $this->setcustomReceipt($customReceipt);
        $this->setShowReceiptPage($showReceiptPage);
    }
    ...
    public function setcustomReceipt($customReceipt) {
